                ...
                <div class="main-logo">
                    <?php
                        ...
                        if($logo != ''){
                            ...
                            echo '<div class="logo-light "><a href="'.home_url('/').'" rel="home"><h4 class="custom-logo">'.get_bloginfo('name').'</h4></a><h6 class="custom-logo">'.get_bloginfo('description').'</h6></div>';
                            echo '<div class="logo-dark"><a href="'.home_url('/').'" rel="home"><h4 class="logo-dark">'.get_bloginfo('name').'</h4></a><h6 class="logo-dark">'.get_bloginfo('description').'</h6></div>';
                        }
